! function() {
  ...
  function f(t) {
    var e = t && t.manifestUrl || "/ngsw-manifest.json",
      ...
      s = new B(O, r),
      a = new D;
    return x.setVerbosity(t.logLevel), t.logHandlers && (x.messages = function(e) {
      return t.logHandlers.forEach(function(t) {
        return t.handle(e)
      })
    }), x.release(), new M(e, n, O, r, i, o, s, a)
  }
  ...
  var A, D = function() {
    ...
    B = function() {
      ...
      return t.prototype.request = function(t) {
        ...
        var e;
        return e = "string" == typeof t ? this.adapter.newRequest(this._cacheBust(t)) : this.adapter.newRequest(this._cacheBust(t.url), t), this.request(e)
  ...
  var k, P = function() {
    ...
    T = x,
    _ = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
    U = u(function(t, e) {
      ! function() {
        function n(t) {
          var e, n, r, i = "",
        ...
        p = {
            ...
            SHA512: function(t) {
              ...
              function i(t, e) {
                ...
                for (t[e >> 5] |= 128 << 24 - (31 & e), t[(e + 128 >> 10 << 5) + 31] = e, i = t.length, r = 0; r < i; r += 32) {
                  ...
                  for (n = 16; n < 80; n += 1) c(_, s[n - 2], 19), p(U, s[n - 2], 29), d(N, s[n - 2], 6), P.l = _.l ^ U.l ^ N.l, P.h = _.h ^ U.h ^ N.h, c(_, s[n - 15], 1), c(U, s[n - 15], 8), d(N, s[n - 15], 7), k.l = _.l ^ U.l ^ N.l, k.h = _.h ^ U.h ^ N.h, y(s[n], P, s[n - 7], k, s[n - 16]);
                  for (n = 0; n < 80; n += 1) x.l = E.l & B.l ^ ~E.l & F.l, x.h = E.h & B.h ^ ~E.h & F.h, c(_, E, 14), c(U, E, 18), p(N, E, 9), P.l = _.l ^ U.l ^ N.l, P.h = _.h ^ U.h ^ N.h, c(_, w, 28), p(U, w, 2), p(N, w, 7), k.l = _.l ^ U.l ^ N.l, k.h = _.h ^ U.h ^ N.h, T.l = w.l & A.l ^ w.l & D.l ^ A.l & D.l, T.h = w.h & A.h ^ w.h & D.h ^ A.h & D.h, v(f, b, P, x, g[n], s[n]), m(l, k, T), u(b, F), u(F, B), u(B, E), m(E, C, f), u(C, D), u(D, A), u(A, w), m(w, f, l);
            ...
            RMD160: function(t) {
              ...
              function u(t, e) {
                ...
                for (t[e >> 5] |= 128 << e % 32, t[(e + 64 >>> 9 << 4) + 14] = e, a = t.length, s = 0; s < a; s += 16) {
                  for (u = y = F, c = v = b, f = C = k, l = E = P, m = B = x, r = 0; r <= 79; r += 1) n = i(u, h(r, c, f, l)), n = i(n, t[s + g[r]]), n = i(n, p(r)), n = i(o(n, A[r]), m), u = m, m = l, l = o(f, 10), f = c, c = n, n = i(y, h(79 - r, v, C, E)), n = i(n, t[s + w[r]]), n = i(n, d(r)), n = i(o(n, D[r]), B), y = B, B = E, E = o(C, 10), C = v, v = n;
                  n = i(b, i(f, E)), b = i(k, i(l, B)), k = i(P, i(m, y)), P = i(x, i(u, v)), x = i(F, i(c, C)), F = n
                }
                return [F, b, k, P, x]
              }
          ...
          function(n, r) {
            var i = !1;
            "object" == typeof e && (i = e, e && "object" == typeof _ && _ && _ === _.global && (n = _)), "function" == typeof define && "object" == typeof define.amd && define.amd ? define(function() {
              return p
  ...
  var M = function() {
      function t(t, e, n, r, i, o, s, a) {
        var u = this;
        this.manifestUrl = t, this.plugins = e, this.scope = n, this.adapter = r, this.cache = i, this.events = o, this.fetcher = s, this.clock = a,
          this.state = k.STARTUP, this.pendingUpdateHash = null, this.streamId = 0, this.streams = {}, this.lifecycleLog = [], this.updateListeners = [], this.id = S++, this.ready = new Promise(function(t) {
            ...
            if (u.state !== k.LAME) {
              if (u.state !== k.STARTUP || u.init || u.startup(), !u.init) throw new Error("init Promise not present in state " + k[u.state]);
              t.respondWith(u.init.then(function() {
                switch (u.state) {
                  case k.READY:
                    return u.active.fetch(e);
                  case k.UPDATE_PENDING:
                    return u.maybeUpdate(t.clientId).then(function() {
                      return u.active.fetch(e)
                    });
                  case k.INSTALLING:
                  case k.LAME:
                    return u.fetcher.request(e);
                  default:
                    return u.fetcher.request(e)
                }
              }))
            ...
            if (u.state !== k.LAME) {
              ...
              1 === t.ports.length && t.data && t.data.hasOwnProperty("$ngsw") && u.init.then(function() {
                if (u.state === k.READY || u.state === k.UPDATE_PENDING) {
                  var e = t.ports[0],
                    n = u.streamId++;
            ...
            if (u.state !== k.LAME) {
              ...
              Promise.all([u.init, t.data.text()]).then(function(t) {
                ...
                u.state !== k.READY && u.state !== k.UPDATE_PENDING || u.active.push(t)
              })
            }
          }
      }
      return t.prototype.lifecycle = function(t) {
        ...
        return this.fetchManifestFromCache("staged").then(function(n) {
          return n ? (!t || n._hash === t) && e.openManifest(n).then(function(t) {
            return e.clearStaged().then(function() {
              ...
              return e.transition(k.READY), !0
            })
          }) : (e.transition(k.READY), !1)
        })
      }, t.prototype.clearActive = function() {
        return this.state === k.READY || this.state === k.UPDATE_PENDING ? Promise.reject("Cannot clear the active manifest when it's being used.") : this.scopedCache.invalidate("active", this.manifestUrl)
        ...
        var t = this;
        return this.state !== k.READY && this.state !== k.UPDATE_PENDING ? (this.lifecycle("skipping update check, in state " + k[this.state]), Promise.resolve(!1)) : this.state === k.UPDATE_PENDING ? Promise.resolve(!0) : Promise.all([this.fetchManifestFromCache("active"), this.fetchManifestFromCache("staged"), this.fetchManifestFromNetwork()]).then(function(e) {
          var n = e[0],
            r = e[1],
            i = e[2];
          if (!i) return !!r && (t.pendingUpdateHash = r._hash, t.transition(k.UPDATE_PENDING), !0);
          if (n && n._hash === i._hash) return !1;
          if (r && r._hash === i._hash) return t.lifecycle("network manifest " + i._hash + " is already staged"), t.pendingUpdateHash = r._hash, t.transition(k.UPDATE_PENDING), !0;
          ...
          return r && (t.lifecycle("staged manifest " + r._hash + " is old, removing"), o = t.clearStaged()), o.then(function() {
            ...
            return t.pendingUpdateHash = i._hash, t.transition(k.UPDATE_PENDING), t.lifecycle("staged update to " + i._hash), !0
          })
        })
      }, t.prototype.initialize = function() {
        var t = this;
        if (this.init) throw new Error("double initialization!");
        return this.state !== k.STARTUP ? Promise.reject(new Error("driver: initialize() called when not in STARTUP state")) : Promise.all([this.fetchManifestFromCache("active"), this.fetchManifestFromCache("staged")]).then(function(e) {
          var n = e[0],
            r = e[1];
          return n ? t.openManifest(n).then(function(e) {
            return e ? (t.lifecycle("manifest " + n._hash + " activated"), t.active = e, r ? (t.lifecycle("staged manifest " + r._hash + " present at initialization"), t.pendingUpdateHash = r._hash, t.transition(k.UPDATE_PENDING), null) : void t.transition(k.READY)) : (t.transition(k.LAME), t.clearActive())
          }) : (t.transition(k.INSTALLING), t.doInstallFromNetwork(), null)
        })
        ...
        return this.fetchManifestFromNetwork().then(function(e) {
          return e ? t.setupManifest(e, null).then(function(n) {
            return n ? void t.setManifest(e, "active").then(function() {
              t.active = n, t.lifecycle("installed version " + e._hash + " from network"), t.transition(k.READY)
            }) : (t.lifecycle("network manifest setup failed"), t.transition(k.LAME), null)
          }) : (t.lifecycle("no network manifest found to install from"), t.transition(k.LAME), null)
        })
        ...
        var e = this;
        if (this.lifecycle("transition from " + k[this.state] + " to " + k[t]), this.state = t, t === k.READY && null !== this.readyResolve) {
          var n = this.readyResolve;
          this.readyResolve = null, n()
        }
        if (t === k.UPDATE_PENDING && null !== this.updatePendingResolve) {
        ...
        t === k.UPDATE_PENDING && null !== this.pendingUpdateHash ? this.updateListeners.forEach(function(t) {
          return e.sendToStream(t, {
            type: "pending",
            version: e.pendingUpdateHash
          })
        }) : t !== k.UPDATE_PENDING && (this.pendingUpdateHash = null)
      }, t.prototype.handleMessage = function(t, e) {
        var n = this;
        if (this.state !== k.READY && this.state !== k.UPDATE_PENDING) return void this.lifecycle("can't handle message in state " + k[this.state]);
        switch (t.cmd) {
          case "ping":
            this.lifecycle("responding to ping on " + e), this.closeStream(e);
            break;
          case "update":
            this.updateListeners.push(e), this.state === k.UPDATE_PENDING && null !== this.pendingUpdateHash && this.sendToStream(e, {
              type: "pending",
    ...
    I = function() {
      function t() {
        this._scope = R.exec(O.registration.scope)[1]
      }
    ...
    J = function() {
      ...
      return Object.defineProperty(t.prototype, "staticManifest", {
        ...
        t.push.apply(t, Object.keys(this.staticManifest.urls).map(function(t) {
          return function() {
            return n.worker.cache.load(n.cacheKey, t).then(function(i) {
              return i ? (T.technical("setup(" + n.cacheKey + ", " + t + "): no need to refresh " + t + " in the cache"), null) : (T.technical("setup(" + n.cacheKey + ", " + t + "): caching from network"), e(n.worker, t, n.cacheKey, r(t))())
            })
          }
        }))
        ...
        t.push.apply(t, Object.keys(this.staticManifest.urls).map(function(t) {
          ...
          return a === s ? (T.technical("update(" + i.cacheKey + ", " + t + "): no need to refresh " + t + " in the cache"), r(n.worker, i.worker, t, i.cacheKey)) : (T.technical("update(" + i.cacheKey + ", " + t + "): caching from network"), e(i.worker, t, i.cacheKey, o(t)))
        }))
      }, t.prototype.fetch = function(t) {
        return o(this.worker, t, this.cacheKey)
      }, t.prototype.cleanup = function(t) {
